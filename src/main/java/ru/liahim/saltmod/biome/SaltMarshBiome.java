...
public class SaltMarshBiome extends SaltBiomeBase{
	public SaltMarshBiome(int id){
		
		super(id, new SaltMarshDecorator());
...
//            Filler Meta
        ...
        this.genBiomeTerrain(world, random, blocks, bytes, x, z, doub);
    }
...
//  Different folliage color depending on coordinates in Biome
    @SideOnly(Side.CLIENT)
