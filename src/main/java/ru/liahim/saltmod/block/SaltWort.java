...
public class SaltWort extends BlockBush implements IGrowable {
  ...
  public void registerBlockIcons(IIconRegister par1) {
    ...
    this.DEAD = par1.registerIcon(getTextureName() + "_D");
  }
  ...
  public boolean canBlockStay(World world, int x, int y, int z) {
    ...
    return ((B.getMaterial() == Material.grass || (B.getMaterial() == Material.ground && B != ModBlocks.saltDirt) || B
      .getMaterial() == Material.sand || B.getMaterial() == Material.clay || (B == ModBlocks.saltDirt && world
      .getBlockMetadata(x, y - 1, z) == 0)) && World.doesBlockHaveSolidTopSurface((IBlockAccess)world, x, y - 1, z));
  }
            ...
            if (S < 7)
              for (int x2 = x - 1; x2 <= x + 1; x2++) {
                for (int z2 = z - 1; z2 <= z + 1; z2++) {
                  ...
                  if (rand.nextInt(8) == 0 && world.isAirBlock(x2, y, z2) && ((B2 == ModBlocks.saltDirtLite && (M2 == 1 || M2 == 2)) || (B2 == ModBlocks.saltDirt && M2 == 0)) && ((B == ModBlocks.saltDirtLite && (M == 1 || M == 2)) || (B == ModBlocks.saltDirt && M == 0))) {
    ...
    for (int x3 = x - 1; x3 <= x + 1; x3++) {
      for (int z3 = z - 1; z3 <= z + 1; z3++) {
        ...
        if (world.getBlock(x3, y, z3) == ModBlocks.saltWort && world.getBlockMetadata(x3, y, z3) < 4)
          if ((B3 == ModBlocks.saltDirt && M3 == 0) || (B3 == ModBlocks.saltDirtLite && (M3 == 1 || M3 == 2))) {
            if (world.getBlockMetadata(x3, y, z3) == 0) {
              world.setBlock(x3, y, z3, ModBlocks.saltWort, 1, 3);
              chek = true;
              P = true;
            } else {
              if (world.getBlockMetadata(x3, y, z3) == 1) {
                world.setBlock(x3, y, z3, ModBlocks.saltWort, 2, 3);
                chek = true;
                P = true;
              } else if (world.getBlockMetadata(x3, y, z3) == 2) {
                world.setBlock(x3, y, z3, ModBlocks.saltWort, 3, 3);
                chek = true;
                P = true;
              } else if (world.getBlockMetadata(x3, y, z3) == 3) {
                world.setBlock(x3, y, z3, ModBlocks.saltWort, 4, 3);
                chek = true;
                P = true;
              } 
