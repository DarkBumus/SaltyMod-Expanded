...
import ru.liahim.saltmod.item.MilkBottle;
...
//  field_76444_x = Absorption
    ...
    public static Item goldenPotato = (new SaltFood("goldenPotato", 6, 0.9F, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 60, 0) }).setCreativeTab(tab).setTextureName("saltmod:GoldenPotato"));
    ...
    public static Item saltMushroomStew = new SaltFood("saltMushroomStew", 7, 0.7F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltMushroomStew");

    public static Item saltRabbitStew = new SaltFood("saltRabbitStew", 11, 0.7F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltRabbitStew");

    public static Item saltBeetrootSoup = new SaltFood("saltBeetrootSoup", 7, 0.7F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltBeetrootSoup");

    public static Item pumpkinPorridge = new SaltFood("pumpkinPorridge", 6, 0.6F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:PumpkinPorridge");

    public static Item saltPumpkinPorridge = new SaltFood("saltPumpkinPorridge", 7, 0.7F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltPumpkinPorridge");

    public static Item cactusStew = new SaltFood("cactusStew", 3, 0.6F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.field_76434_w.id, 400, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:CactusStew");

    public static Item saltCactusStew = new SaltFood("saltCactusStew", 4, 0.7F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.field_76434_w.id, 800, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltCactusStew");

    public static Item vegetableStew = new SaltFood("vegetableStew", 5, 0.6F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:VegetableStew");

    public static Item saltVegetableStew = new SaltFood("saltVegetableStew", 6, 0.7F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltVegetableStew");

    public static Item potatoMushroom = new SaltFood("potatoMushroom", 5, 0.6F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:PotatoMushroom");

    public static Item saltPotatoMushroom = new SaltFood("saltPotatoMushroom", 6, 0.7F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltPotatoMushroom");

    public static Item goldenVegetables = new SaltFood("goldenVegetables", 6, 1.2F, Items.bowl, new PotionEffect[] {new PotionEffect(Potion.regeneration.id, 80, 1) }).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:GoldenVegetables");

    public static Item saltGoldenVegetables = new SaltFood("saltGoldenVegetables", 7, 1.2F, Items.bowl, new PotionEffect[] {new PotionEffect(Potion.regeneration.id, 100, 2) }).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltGoldenVegetables");

    public static Item fishSoup = new SaltFood("fishSoup", 6, 0.6F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:FishSoup");

    public static Item saltFishSoup = new SaltFood("saltFishSoup", 7, 0.7F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltFishSoup");

    public static Item fishSalmonSoup = new SaltFood("fishSalmonSoup", 7, 0.8F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:FishSalmonSoup");

    public static Item saltFishSalmonSoup = new SaltFood("saltFishSalmonSoup", 8, 0.9F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltFishSalmonSoup");

    public static Item fishClownfishSoup = new SaltFood("fishClownfishSoup", 4, 0.6F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:FishClownfishSoup");

    public static Item saltFishClownfishSoup = new SaltFood("saltFishClownfishSoup", 5, 0.7F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltFishClownfishSoup");

    public static Item dandelionSalad = new SaltFood("dandelionSalad", 4, 0.6F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.field_76434_w.id, 800, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:DandelionSalad");

    public static Item saltDandelionSalad = new SaltFood("saltDandelionSalad", 5, 0.7F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.field_76434_w.id, 1200, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltDandelionSalad");

    public static Item wheatSprouts = new SaltFood("wheatSprouts", 3, 0.6F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.field_76434_w.id, 600, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:WheatSprouts");

    public static Item saltWheatSprouts = new SaltFood("saltWheatSprouts", 4, 0.7F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.field_76434_w.id, 900, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltWheatSprouts");

    public static Item beetrootSalad = new SaltFood("beetrootSalad", 5, 0.4F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:BeetrootSalad");

    public static Item saltBeetrootSalad = new SaltFood("saltBeetrootSalad", 6, 0.5F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltBeetrootSalad");

    public static Item herringUFC = new SaltFood("herringUFC", 8, 0.9F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:HerringUFC");

    public static Item saltHerringUFC = new SaltFood("saltHerringUFC", 9, 1.0F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltHerringUFC");

    public static Item saltWortSalad = new SaltFood("saltWortSalad", 6, 0.4F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 200, 1) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltWortSalad");

    public static Item goldenSaltWortSalad = new SaltFood("goldenSaltWortSalad", 7, 1.2F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 400, 1) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:GoldenSaltWortSalad");

    public static Item saltWortBeef = new SaltFood("saltWortBeef", 10, 0.9F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 400, 1) }).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltWortBeef");

    public static Item saltWortPorkchop = new SaltFood("saltWortPorkchop", 10, 0.9F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 400, 1) }).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltWortPorkchop");

    public static Item saltWortHoneyedPorkchop = new SaltFood("saltWortHoneyedPorkchop", 9, 0.9F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 400, 1),  new PotionEffect(Potion.field_76444_x.id, 900, 2) }).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltWortHoneyedPorkchop");

    public static Item saltWortMutton = new SaltFood("saltWortMutton", 8, 0.9F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 400, 1) }).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltWortMutton");

    public static Item saltWortHaunch = new SaltFood("saltWortHaunch", 10, 0.9F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 400, 1) }).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltWortHaunch");
    ...
    public static Item fruitSalad = new SaltFood("fruitSalad", 5, 0.4F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.moveSpeed.id, 900, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:FruitSalad");

    public static Item sugarFruitSalad = new SaltFood("sugarFruitSalad", 6, 0.5F, Items.bowl, new PotionEffect[] {new PotionEffect(Potion.moveSpeed.id, 1200, 1) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SugarFruitSalad");

    public static Item goldenFruitSalad = new SaltFood("goldenFruitSalad", 5, 0.8F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 100, 1), new PotionEffect(Potion.field_76444_x.id, 2400), new PotionEffect(Potion.heal.id, 1) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:GoldenFruitSalad");

    public static Item sugarGoldenFruitSalad = new SaltFood("sugarGoldenFruitSalad", 6, 0.8F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 125, 2), new PotionEffect(Potion.field_76444_x.id, 3000, 1), new PotionEffect(Potion.heal.id, 1, 1) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SugarGoldenFruitSalad");

    public static Item gratedCarrot = new SaltFood("gratedCarrot", 5, 0.4F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.nightVision.id, 900, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:GratedCarrot");

    public static Item sugarGratedCarrot = new SaltFood("sugarGratedCarrot", 6, 0.5F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.nightVision.id, 1200, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SugarGratedCarrot");

    public static Item melonSoup = new SaltFood("melonSoup", 4, 0.4F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.jump.id, 900, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:MelonSoup");

    public static Item sugarMelonSoup = new SaltFood("sugarMelonSoup", 4, 0.4F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.jump.id, 1200, 1) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SugarMelonSoup");

    public static Item honeyedBerries = new SaltFood("honeyedBerries", 2, 0.2F, new PotionEffect[] { new PotionEffect(Potion.field_76444_x.id, 300) }).setCreativeTab(tab).setTextureName("saltmod:HoneyedBerries");

    public static Item honeyedApple = new SaltFood("honeyedApple", 4, 0.4F, new PotionEffect[] { new PotionEffect(Potion.field_76444_x.id, 600, 1) }).setCreativeTab(tab).setTextureName("saltmod:HoneyedApple");

    public static Item honeyedPorkchop = new SaltFood("honeyedPorkchop", 8, 0.9F, new PotionEffect[] { new PotionEffect(Potion.field_76444_x.id, 900, 2) }).setCreativeTab(tab).setTextureName("saltmod:HoneyedPorkchop");

    public static Item chocolateBerries = new SaltFood("chocolateBerries", 2, 0.2F, new PotionEffect[] { new PotionEffect(Potion.digSpeed.id, 300, 0) }).setCreativeTab(tab).setTextureName("saltmod:ChocolateBerries");

    public static Item chocolateBar = new ChocolateBar("chocolateBar", tab, "ChocolateBar");

    public static Item chocolatePie = new SaltFood("chocolatePie", 7, 0.3F, new PotionEffect[] {new PotionEffect(Potion.digSpeed.id, 900, 2) }).setCreativeTab(tab).setTextureName("saltmod:ChocolatePie");
    ...
    public static Item saltWortPie = new SaltFood("saltWortPie", 6, 0.3F, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 100, 0) }).setAlwaysEdible().setCreativeTab(tab).setTextureName("saltmod:SaltWortPie");

    public static Item fermentedSaltWort = new SaltFood("fermentedSaltWort", 5, 0.8F, Items.glass_bottle, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 600, 2) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:SaltWortFermented");

    public static Item pickledMushroom = new SaltFood("pickledMushroom", 6, 0.8F, Items.glass_bottle, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:PickledMushroom");

    public static Item pickledFern = new SaltFood("pickledFern", 4, 0.8F, Items.glass_bottle, new PotionEffect[] { new PotionEffect(Potion.resistance.id, 800, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:PickledFern");

    public static Item pickledCalamari = new SaltFood("pickledCalamari", 6, 0.8F, Items.glass_bottle, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:PickledCalamari");

    public static Item pickledOnion = new SaltFood("pickledOnion", 4, 0.8F, Items.glass_bottle, new PotionEffect[]{ new PotionEffect(Potion.resistance.id, 800, 0) }).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:PickledOnion");

    public static Item preservedMelon = new SaltFood("preservedMelon", 6, 0.8F, Items.glass_bottle, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:PreservedMelon");

    public static Item preservedSweetberries = new SaltFood("preservedSweetberries", 6, 0.8F, Items.glass_bottle, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:PreservedSweetberries");

    public static Item preservedApple = new SaltFood("preservedApple", 8, 0.8F, Items.glass_bottle, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:PreservedApple");
    ...
    public static Item hemoglobin = new SaltFood("hemoglobin", 2, 4.0F, new PotionEffect[] { new PotionEffect(Potion.heal.id, 1, 1) }).setAlwaysEdible().setCreativeTab(tab).setTextureName("saltmod:Hemoglobin");
    ...
    public static Item tf_saltMeefStroganoff = new SaltFood("tf_saltMeefStroganoff", 9, 0.7F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:" + "tf/" + "TF_SaltMeefStroganoff");
    ...
    public static Item tf_pickledMushgloom = new SaltFood("tf_pickledMushgloom", 6, 0.8F, Items.glass_bottle, new PotionEffect[] { new PotionEffect(Potion.nightVision.id, 1200, 0), new PotionEffect(Potion.moveSlowdown.id, 100, 0) }).setAlwaysEdible().setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:" + "tf/" + "TF_PickledMushgloom");

    public static Item tf_saltWortVenison = new SaltFood("tf_saltWortVenison", 10, 0.9F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 100, 0) }).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:" + "tf/" + "TF_SaltWortVenison");

    public static Item tf_saltWortMeefSteak = new SaltFood("tf_saltWortMeefSteak", 8, 0.9F, Items.bowl, new PotionEffect[] { new PotionEffect(Potion.regeneration.id, 100, 0) }).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:" + "tf/" + "TF_SaltWortMeefSteak");
    ...
    public static Item bop_sugarSaladFruit = ((ItemFood)(new SaltFood("bop_sugarSaladFruit", 7, 0.7F, Items.bowl, new PotionEffect[0])).setMaxStackSize(1).setCreativeTab(tab)).setPotionEffect(Potion.digSpeed.id, 1200, 2, 0.1F).setTextureName("saltmod:" + "bop/" + "BOP_SaltSaladVeggie");

    public static Item bop_saltSaladVeggie = ((ItemFood)(new SaltFood("bop_saltSaladVeggie", 7, 0.7F, Items.bowl, new PotionEffect[0])).setMaxStackSize(1).setCreativeTab(tab)).setPotionEffect(Potion.field_76434_w.id, 1550, 2, 0.1F).setTextureName("saltmod:" + "bop/" + "BOP_SaltSaladVeggie");

    public static Item bop_saltSaladShroom = ((ItemFood)(new SaltFood("bop_saltSaladShroom", 7, 0.7F, Items.bowl, new PotionEffect[0])).setMaxStackSize(1).setCreativeTab(tab)).setPotionEffect(Potion.jump.id, 900, 2, 0.1F).setTextureName("saltmod:" + "bop/" + "BOP_SaltSaladShroom");

    public static Item bop_saltRiceBowl = new SaltFood("bop_saltRiceBowl", 3, 0.2F, Items.bowl, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:" + "bop/" + "BOP_SaltRiceBowl");

    public static Item bop_pickledTurnip = new SaltFood("bop_pickledTurnip", 6, 0.8F, Items.glass_bottle, new PotionEffect[0]).setMaxStackSize(1).setCreativeTab(tab).setTextureName("saltmod:" + "bop/" + "BOP_PickledTurnip");
