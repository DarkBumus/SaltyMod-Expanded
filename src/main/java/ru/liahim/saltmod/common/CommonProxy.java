...
import ru.liahim.saltmod.entity.DropHandler;
...
//  Pickled Ingredient Rules:		1. Salt Pinch, 2. Water Bottle, 3. Ingredient
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltHaunchCooked), new Object[] { new ItemStack(ModItems.saltPinch), new ItemStack(ModItems.haunchCooked)});
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltFishClownfishCooked), new Object[] { new ItemStack(ModItems.saltPinch), new ItemStack(ModItems.fishClownfishCooked) });
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltCalamariCooked), new Object[] { new ItemStack(ModItems.saltPinch), new ItemStack(ModItems.calamariCooked) });
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.goldenVegetables), new Object[] { new ItemStack(Items.bowl), new ItemStack(Items.golden_carrot), new ItemStack(ModItems.goldenPotato), new ItemStack(ModItems.goldenSaltWortSeed) });
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltGoldenVegetables), new Object[] { new ItemStack(ModItems.saltPinch), new ItemStack(Items.bowl), new ItemStack(Items.golden_carrot), new ItemStack(ModItems.goldenPotato), new ItemStack(ModItems.goldenSaltWortSeed) });
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltWortHaunch), new Object[] { new ItemStack(Items.bowl), new ItemStack(ModItems.haunchCooked), new ItemStack(ModItems.saltWortSeed), new ItemStack(ModItems.saltWortSeed) });
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.calamariPie), new Object[] { new ItemStack(ModItems.salt), new ItemStack(ModItems.calamariRaw), new ItemStack(Items.wheat), new ItemStack(Items.egg) });
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.pickledCalamari), new Object[] { new ItemStack(ModItems.saltPinch), new ItemStack(Items.potionitem), new ItemStack(ModItems.calamariRaw), new ItemStack(ModItems.calamariRaw) });
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.goldenPotato), new Object[] { "xxx", "xyx", "xxx", Character.valueOf('x'), Items.gold_nugget, Character.valueOf('y'), Items.potato });
...
//      	  GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltBeetrootSoup), new Object[] { new ItemStack(ModItems.saltPinch), new ItemStack(beetroot_soup) });
            ...
            if(sweet_berries != null) {
                ...
                GameRegistry.addShapelessRecipe(new ItemStack(ModItems.goldenFruitSalad), new Object[] { new ItemStack(Items.bowl), new ItemStack(Items.golden_apple), new ItemStack(ModItems.goldenBerries), new ItemStack(Items.speckled_melon) });
                GameRegistry.addShapelessRecipe(new ItemStack(ModItems.sugarGoldenFruitSalad), new Object[] { new ItemStack(ModItems.sugarPinch), new ItemStack(Items.bowl), new ItemStack(Items.golden_apple), new ItemStack(ModItems.goldenBerries), new ItemStack(Items.speckled_melon) });
                ...
                GameRegistry.addRecipe(new ItemStack(ModItems.goldenBerries), new Object[] { "xxx", "xyx", "xxx", Character.valueOf('x'), Items.gold_nugget, Character.valueOf('y'), new ItemStack(sweet_berries) });
            }
        } else {
