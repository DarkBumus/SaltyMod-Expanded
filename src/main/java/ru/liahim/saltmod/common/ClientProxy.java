...
public class ClientProxy extends CommonProxy {
  ...
  public static void setBlockRenderers() {
    ...
    RenderingRegistry.registerBlockHandler((ISimpleBlockRenderingHandler)new SaltGrassRenderer());
    extractorRenderType = RenderingRegistry.getNextAvailableRenderId();
    RenderingRegistry.registerBlockHandler((ISimpleBlockRenderingHandler)new ExtractorRenderer());
  }
  
  @SideOnly(Side.CLIENT)
  public static void setEntityRenderers() {
    RenderingRegistry.registerEntityRenderingHandler(EntityRainmaker.class, (Render)new RenderSnowball(ModItems.rainmaker));
    RenderingRegistry.registerEntityRenderingHandler(EntityRainmakerDust.class, (Render)new RenderRainmakerDust());
  }
}