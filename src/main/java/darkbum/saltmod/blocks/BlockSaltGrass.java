...
public class BlockSaltGrass extends Block implements IGrowable {
    ...
    public void registerBlockIcons(IIconRegister par1) {
        this.blockIcon = par1.registerIcon("saltmod:slightly_saline_grass");
        this.TOP = par1.registerIcon("saltmod:slightly_saline_grass_top");
        this.SIDE = par1.registerIcon("saltmod:slightly_saline_grass_side_0");
        this.SIDE_L = par1.registerIcon("saltmod:slightly_saline_grass_side_1");
        this.SIDE_R = par1.registerIcon("saltmod:slightly_saline_grass_side_2");
        this.BOTTOM0 = par1.registerIcon("saltmod:slightly_saline_dirt_0");
        this.BOTTOM1 = par1.registerIcon("saltmod:slightly_saline_dirt_bottom");
    }
