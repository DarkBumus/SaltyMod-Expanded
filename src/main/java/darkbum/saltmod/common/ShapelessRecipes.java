...
//  Pickled Ingredient Rules:		1. Salt Pinch, 2. Water Bottle, 3. Ingredient
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltWortPorkchop), new ItemStack(Items.bowl), new ItemStack(ModItems.saltPorkchopCooked), new ItemStack(ModItems.saltWortSeed), new ItemStack(ModItems.saltWortSeed));
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltWortHoneyPorkchop), new ItemStack(Items.bowl), new ItemStack(ModItems.honeyPorkchop), new ItemStack(ModItems.saltWortSeed), new ItemStack(ModItems.saltWortSeed));
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltWortBeef), new ItemStack(Items.bowl), new ItemStack(ModItems.saltBeefCooked), new ItemStack(ModItems.saltWortSeed), new ItemStack(ModItems.saltWortSeed));
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltWortMutton), new ItemStack(Items.bowl), new ItemStack(ModItems.saltMuttonCooked), new ItemStack(ModItems.saltWortSeed), new ItemStack(ModItems.saltWortSeed));
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltWortStrider), new ItemStack(Items.bowl), new ItemStack(ModItems.saltStriderCooked), new ItemStack(ModItems.saltWortSeed), new ItemStack(ModItems.saltWortSeed));
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.saltWortHaunch), new ItemStack(Items.bowl), new ItemStack(ModItems.saltHaunchCooked), new ItemStack(ModItems.saltWortSeed), new ItemStack(ModItems.saltWortSeed));
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.tf_saltWortVenison), new ItemStack(Items.bowl), new ItemStack(ModItems.tf_saltVenisonCooked), new ItemStack(ModItems.saltWortSeed), new ItemStack(ModItems.saltWortSeed));
        GameRegistry.addShapelessRecipe(new ItemStack(ModItems.tf_saltWortMeefSteak), new ItemStack(Items.bowl), new ItemStack(ModItems.tf_saltMeefSteak), new ItemStack(ModItems.saltWortSeed), new ItemStack(ModItems.saltWortSeed));
