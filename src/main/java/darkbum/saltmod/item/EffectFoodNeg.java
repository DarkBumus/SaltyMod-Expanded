...
public class EffectFoodNeg extends SaltFood {
    public EffectFoodNeg(String name, CreativeTabs tab, String textureName) {
        super("effectFoodNeg", 0, 0.0F, new PotionEffect(Potion.blindness.id, 1200, 0), new PotionEffect(Potion.confusion.id, 1200, 0), new PotionEffect(Potion.digSlowdown.id, 1200, 0), new PotionEffect(Potion.harm.id, 1200, 0), new PotionEffect(Potion.hunger.id, 1200, 0), new PotionEffect(Potion.moveSlowdown.id, 1200, 0), new PotionEffect(Potion.poison.id, 1200, 0), new PotionEffect(Potion.weakness.id, 1200, 0), new PotionEffect(Potion.wither.id, 1200, 0));
