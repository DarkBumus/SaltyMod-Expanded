 ...
 * @since 1.9.f
 */
public class SaltFlowerDirtMessage implements IMessage {
    ...
    public SaltFlowerDirtMessage() {}

    /**
     * Constructs a new SaltFlowerDirtMessage with specified coordinates and metadata value.
     *
     ...
     */
    public SaltFlowerDirtMessage(int x, int y, int z, int i) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.i = i;
    ...
    /**
     * Handles the received SaltFlowerDirtMessage on the client side.
     * Updates the specified Flower Pot to contain a Saltwort item with the specified metadata value.
     */
    public static class Handler implements IMessageHandler<SaltFlowerDirtMessage, IMessage> {

        /**
         * Processes the received message.
         *
         * @param message The received SaltFlowerDirtMessage containing the Flower Pot coordinates and metadata value.
         ...
         */
        @Override
        public IMessage onMessage(SaltFlowerDirtMessage message, MessageContext context) {
            SaltFlowerDirtMessage.act(message.x, message.y, message.z, message.i);
            return null;
        }
    }
     ...
     * This method is client-side only and is called when the SaltFlowerDirtMessage is received.
     *
     * @param x The x-coordinate of the Flower Pot tile entity.
     * @param y The y-coordinate of the Flower Pot tile entity.
     * @param z The z-coordinate of the Flower Pot tile entity.
    ...
    private static void act(int x, int y, int z, int i) {
        ...
        if (world.getTileEntity(x, y, z) != null && world.getTileEntity(x, y, z) instanceof TileEntityFlowerPot tileEntity) {
            tileEntity.func_145964_a(Item.getItemFromBlock(ModBlocks.salt_flower_d), i);
