        ...
        for(int lake = 0; lake < SaltConfig.saltLakeQuantity; lake++) {
            for(int originY = 60; originY < 75; originY++) {
                ...
                if((other instanceof BlockGrass || other == Blocks.stone || other == ModBlocks.salt_grass) &&
                    ...
                    world.setBlockToAir(originX, originY - 1, originZ);
                    world.setBlock(originX, originY - 2, originZ, ModBlocks.salt_lake);
                        ...
                        for(j = originX - i; j <= originX + i; j++) {
                            for(int z = originZ - i; z <= originZ + i; z++) {
                                if (rand.nextInt(2) == 0 &&
                                    ...
                                    (world.getBlock(j - 1, originY - 2, z) == ModBlocks.salt_lake ||
                                        world.getBlock(j + 1, originY - 2, z) == ModBlocks.salt_lake ||
                                        world.getBlock(j, originY - 2, z - 1) == ModBlocks.salt_lake ||
                                        world.getBlock(j, originY - 2, z + 1) == ModBlocks.salt_lake)) {
                        ...
                        for (j = originX - i; j <= originX + i; j++) {
                            for (int z = originZ - i; z <= originZ + i; z++) {
                                if (world.getBlock(j, originY - 2, z) == ModBlocks.salt_block) {
                                    world.setBlock(j, originY - 2, z, ModBlocks.salt_lake);
                    ...
                    for (x = originX - radius; x <= originX + radius; x++) {
                        for (int z = originZ - radius; z <= originZ + radius; z++) {
                            if (world.getBlock(x, originY - 2, z) == ModBlocks.salt_lake) {
                                world.setBlockToAir(x, originY, z);
                            } else {
                                int mask1 = 0;
                                if (world.getBlock(x, originY - 2, z - 1) == ModBlocks.salt_lake)
                                    mask1++;
                                if (world.getBlock(x + 1, originY - 2, z) == ModBlocks.salt_lake)
                                    mask1 += 2;
                                if (world.getBlock(x, originY - 2, z + 1) == ModBlocks.salt_lake)
                                    mask1 += 4;
                                if (world.getBlock(x - 1, originY - 2, z) == ModBlocks.salt_lake)
                                    mask1 += 8;
                                int mask2 = 0;
                                if (world.getBlock(x + 1, originY - 2, z - 1) == ModBlocks.salt_lake)
                                    mask2++;
                                if (world.getBlock(x + 1, originY - 2, z + 1) == ModBlocks.salt_lake)
                                    mask2 += 2;
                                if (world.getBlock(x - 1, originY - 2, z + 1) == ModBlocks.salt_lake)
                                ...
                                if (mask1 > 0) {
                                    if (world.getBlock(x, originY - 2, z) != ModBlocks.salt_dirt && world.getBlock(x, originY - 2, z) != ModBlocks.lite_salt_dirt && world.getBlock(x, originY - 2, z) != ModBlocks.salt_ore)
                                    ...
                                    if (world.getBlock(x, originY - 1, z) instanceof BlockDirt || world.getBlock(x, originY - 1, z) == ModBlocks.mineral_mud) {
                                        world.setBlock(x, originY - 1, z, ModBlocks.lite_salt_dirt, crustMeta, 3);
                                    }
                                    if (world.isAirBlock(x, originY - 1, z)) {
                                        int jld = 0;
                                        if (world.getBlock(x, originY - 3, z - 1) == ModBlocks.salt_lake || world.getBlock(x, originY - 3, z - 1) == ModBlocks.salt_dirt)
                                            jld++;
                                        if (world.getBlock(x + 1, originY - 3, z) == ModBlocks.salt_lake || world.getBlock(x + 1, originY - 3, z) == ModBlocks.salt_dirt)
                                            jld += 2;
                                        if (world.getBlock(x, originY - 3, z + 1) == ModBlocks.salt_lake || world.getBlock(x, originY - 3, z + 1) == ModBlocks.salt_dirt)
                                            jld += 4;
                                        if (world.getBlock(x - 1, originY - 3, z) == ModBlocks.salt_lake || world.getBlock(x - 1, originY - 3, z) == ModBlocks.salt_dirt)
                                            jld += 8;
                                        if (jld > 0) {
                                            world.setBlock(x, originY - 2, z, ModBlocks.salt_lake, jld, 3);
                                        } else {
                                            world.setBlock(x, originY - 2, z, ModBlocks.salt_dirt, 1, 3);
                                        }
                                    }
                                    if(world.getFullBlockLightValue(x, originY + 1, z) >= 12) {
                                        if(world.getBlock(x - 1, originY - 1, z) == ModBlocks.salt_lake ||
                                            world.getBlock(x + 1, originY - 1, z) == ModBlocks.salt_lake ||
                                            world.getBlock(x, originY - 1, z - 1) == ModBlocks.salt_lake ||
                                            world.getBlock(x, originY - 1, z + 1) == ModBlocks.salt_lake ||
                                            world.getBlock(x - 1, originY - 1, z) == ModBlocks.salt_dirt ||
                                            world.getBlock(x + 1, originY - 1, z) == ModBlocks.salt_dirt ||
                                            world.getBlock(x, originY - 1, z - 1) == ModBlocks.salt_dirt ||
                                            world.getBlock(x, originY - 1, z + 1) == ModBlocks.salt_dirt) {
                                            int jl = 0;
                                            if (world.getBlock(x, originY - 2, z - 1) == ModBlocks.salt_lake || world.getBlock(x, originY - 2, z - 1) == ModBlocks.salt_dirt)
                                                jl++;
                                            if (world.getBlock(x + 1, originY - 2, z) == ModBlocks.salt_lake || world.getBlock(x + 1, originY - 2, z) == ModBlocks.salt_dirt)
                                                jl += 2;
                                            if (world.getBlock(x, originY - 2, z + 1) == ModBlocks.salt_lake || world.getBlock(x, originY - 2, z + 1) == ModBlocks.salt_dirt)
                                                jl += 4;
                                            if (world.getBlock(x - 1, originY - 2, z) == ModBlocks.salt_lake || world.getBlock(x - 1, originY - 2, z) == ModBlocks.salt_dirt)
                                                jl += 8;
                                            world.setBlock(x, originY - 1, z, ModBlocks.salt_lake, jl, 3);
                                        }
                                        if (!(world.getBlock(x - 1, originY, z).getMaterial() instanceof MaterialLiquid) &&
                                            ...
                                            !(world.getBlock(x, originY, z + 1).getMaterial() instanceof MaterialLiquid)) {
                                            if (world.getBlock(x, originY - 1, z) == ModBlocks.lite_salt_dirt && (world.getBlock(x, originY, z) instanceof BlockGrass) || world.getBlock(x, originY, z) == ModBlocks.salt_grass) {
                                            ...
                                            if (rand.nextInt(10) == 0 && (other == ModBlocks.salt_grass || other == ModBlocks.lite_salt_dirt)) {
                                        ...
                                        } else if (world.getBlock(x, originY, z) == ModBlocks.lite_salt_dirt) {
                                    ...
                                    if (world.getBlock(x, originY - 1, z).getMaterial().isSolid() && world.getBlock(x, originY - 2, z) != ModBlocks.lite_salt_dirt && world.getBlock(x, originY - 2, z) != ModBlocks.salt_ore) {
                                        world.setBlock(x, originY - 2, z, Blocks.stone);
                                    }
                    ...
                    for(x = originX - radius; x <= originX + radius; x++) {
                        for(int z = originZ - radius; z <= originZ + radius; z++) {
                            ...
                            other = world.getBlock(x, originY - 1, z);
                            if ((other == ModBlocks.salt_grass || other == ModBlocks.lite_salt_dirt) &&
