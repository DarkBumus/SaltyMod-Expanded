...
public class SaltLakeGenerator implements IWorldGenerator {
    ...
    public void generateOverworld(World world, Random rand, int X1, int Z1) {
        if (!world.isRemote) {
            int rad = ModConfiguration.saltLakeRadius;
            int randPosX = X1 + rand.nextInt(16);
            int randPosZ = Z1 + rand.nextInt(16);
            if (rand.nextInt(ModConfiguration.saltLakeFrequency) == 0 && world
                .getBiomeGenForCoords(randPosX, randPosZ) != BiomeGenBase.swampland)
                for (int G = 0; G < ModConfiguration.saltLakeQuantity; G++) {
                        ...
                        if ((world.getBlock(randPosX, randPosY, randPosZ) instanceof BlockGrass ||
                            ...
                            for (x = randPosX - rad; x <= randPosX + rad; x++) {
                                for (int z = randPosZ - rad; z <= randPosZ + rad; z++) {
                                    if (world.getBlock(x, randPosY - 2, z) == ModBlocks.salt_lake) {
                                        ...
                                        if (jf > 0) {
                                            if (world.getBlock(x, randPosY - 2, z) != ModBlocks.salt_dirt && world.getBlock(x, randPosY - 2, z) != ModBlocks.salt_dirt_lite && world.getBlock(x, randPosY - 2, z) != ModBlocks.salt_ore)
                                            ...
                                            if (world.getFullBlockLightValue(x, randPosY + 1, z) >= 12) {
                                                ...
                                                } else if (world.getBlock(x, randPosY, z) == ModBlocks.salt_dirt_lite) {
                                            ...
                                            if (world.getBlock(x, randPosY - 1, z).getMaterial().isSolid() && world.getBlock(x, randPosY - 2, z) != ModBlocks.salt_dirt_lite && world.getBlock(x, randPosY - 2, z) != ModBlocks.salt_ore)
                                                world.setBlock(x, randPosY - 2, z, Blocks.stone);
                            ...
                            for (x = randPosX - rad; x <= randPosX + rad; x++) {
                                for (int z = randPosZ - rad; z <= randPosZ + rad; z++) {
                                    ...
                                    if ((world.getBlock(x, randPosY - 1, z) == ModBlocks.salt_grass || world.getBlock(x, randPosY - 1, z) == ModBlocks.salt_dirt_lite) &&
                    ...
                    randPosX = randPosX + rand.nextInt(ModConfiguration.saltLakeDistance) - ModConfiguration.saltLakeDistance / 2;
                    randPosZ = randPosZ + rand.nextInt(ModConfiguration.saltLakeDistance) - ModConfiguration.saltLakeDistance / 2;
                }
        }
    }
}
