        ...
        if (enableEvaporator) {
            ...
            if (isModLoaded("BiomesOPlenty") && enableBOPFoods) {
                if (isFluidRegistered("blood")) {
                    ...
                    registerItem(ModItems.bop_hemoglobin, "bop_hemoglobin");
                ...
                Item bop_dart = findItem("BiomesOPlenty", "dart");
                ItemStack bop_poisondart = new ItemStack(bop_dart, 1, 1);
                if (bop_dart != null && isFluidRegistered("poison")) {
                    Fluid poisonFl = getFluid("poison");
                    registerItem(ModItems.bop_poison, "bop_poison");
                    instance().addEvaporating(poisonFl, ModItems.bop_poison, 1000, 1.0F);
                    addShapelessRecipe(bop_poisondart, new ItemStack(bop_dart), ModItems.bop_poison);
                }
            }
        }
    }
