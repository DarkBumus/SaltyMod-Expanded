...
public class BlockApiary extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister icon) {
        this.iconBottom = icon.registerIcon("saltymod:apiary_bottom");
        this.iconTop = icon.registerIcon("saltymod:apiary_top");
        this.iconSide = icon.registerIcon("saltymod:apiary_side");
        this.iconFront = icon.registerIcon("saltymod:apiary_front");
    }
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int meta) {
        ...
        if (tileEntityApiary != null) {
            ...
            for (int i1 = 0; i1 < tileEntityApiary.getSizeInventory(); i1++) {
                ItemStack stack = tileEntityApiary.getStackInSlot(i1);
    ...
    public int getComparatorInputOverride(World world, int x, int y, int z, int side) {
        ...
        if (tile instanceof TileEntityApiary) return ((TileEntityApiary) tile).getComparatorInputOverride();
        return 0;
    }
}
