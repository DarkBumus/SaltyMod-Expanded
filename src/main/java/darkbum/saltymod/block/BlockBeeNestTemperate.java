...
public class BlockBeeNestTemperate extends Block {
    ...
    public BlockBeeNestTemperate(String name, CreativeTabs tab) {
        super(Material.wood);
    ...
    public void registerBlockIcons(IIconRegister icon) {
        this.TOP = icon.registerIcon("saltymod:bee_nest_temperate_top");
        this.BOTTOM = icon.registerIcon("saltymod:bee_nest_temperate_bottom");
        this.SIDE = icon.registerIcon("saltymod:bee_nest_temperate_side");
        this.BURROW = icon.registerIcon("saltymod:bee_nest_temperate_burrow");
    }
