...
public class ContainerEvaporator extends Container {
    ...
    public void detectAndSendChanges() {
        ...
        for (Object crafter : this.crafters) {
            ...
            if (this.lastEvaporateTime != this.te.evaporateTime)
                iCrafting.sendProgressBarUpdate(this, 0, this.te.evaporateTime);
            if (this.lastBurnTime != this.te.burningTime) iCrafting.sendProgressBarUpdate(this, 1, this.te.burningTime);
    ...
    public void updateProgressBar(int id, int v) {
        if (id == 0) this.te.evaporateTime = v;
        if (id == 1) this.te.burningTime = v;
        if (id == 2) this.te.currentItemBurnTime = v;
        if (id == 3) this.te.liquidID = v;
        if (id == 4) this.te.liquidLevel = v;
        if (id == 5) this.te.pressure = v;
    }
